...
const modelosCarros = [
    { marca: "Toyota", modelo: "Corolla", cores_disponiveis: ["Branco", "Preto"], valor: 120000 },
    { marca: "Toyota", modelo: "Yaris", cores_disponiveis: ["Vermelho", "Azul"], valor: 90000 },
    { marca: "Honda", modelo: "Civic", cores_disponiveis: ["Cinza", "Preto"], valor: 150000 },
    { marca: "Honda", modelo: "Fit", cores_disponiveis: ["Branco", "Azul"], valor: 85000 }
];
...
async function carregarOpcoes(tipo, select, filtros = {}, campoValor = null) {
    try {
        ...
        let dataFiltrada = modelosCarros.filter(item => {
